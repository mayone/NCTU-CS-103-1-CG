...
int main(int argc, char** argv)
{
	...
	scene_data = new scene("HW2DisplacementMap.scene", 1);
...
void LoadShaders()
{
	...
	if(ShaderProgram != 0)
	{
		ShaderLoad(ShaderProgram, "DisplacementMapShader.vert", GL_VERTEX_SHADER);
		ShaderLoad(ShaderProgram, "DisplacementMapShader.frag", GL_FRAGMENT_SHADER);
	}
}
...
void LinkMaps()
{
	...
	glBindAttribLocation(ShaderProgram, 2, "scaling_factor");
	glVertexAttrib1f(2, scaling_factor);
}
